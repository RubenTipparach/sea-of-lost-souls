...
use sol_assets::{
    ...
    Production, Reactor, ShipDef, Shields, Subsystem,
};
use std::path::Path;
...
const SPECS: [ClassSpec; 8] = [
    ClassSpec { id: "fighter", name: "Fighter", class: "strike", hull: HullKind::Fighter, accent: [60, 150, 220], mass: 18.0, max_speed: 16.0, accel: 24.0, turn_deg: 130.0, crew: 2, salvage: 30.0, build_time: 12.0, cargo: None, bays: None },
    ClassSpec { id: "bomber", name: "Bomber", class: "strike", hull: HullKind::Bomber, accent: [210, 120, 40], mass: 30.0, max_speed: 12.0, accel: 16.0, turn_deg: 90.0, crew: 3, salvage: 50.0, build_time: 18.0, cargo: None, bays: None },
    ClassSpec { id: "corvette", name: "Corvette", class: "light_line", hull: HullKind::Corvette, accent: [80, 200, 150], mass: 220.0, max_speed: 10.0, accel: 12.0, turn_deg: 70.0, crew: 6, salvage: 120.0, build_time: 28.0, cargo: None, bays: None },
    ClassSpec { id: "resourcer", name: "Resourcer", class: "utility", hull: HullKind::Resourcer, accent: [220, 200, 90], mass: 140.0, max_speed: 8.0, accel: 9.0, turn_deg: 55.0, crew: 3, salvage: 80.0, build_time: 22.0, cargo: Some(200.0), bays: None },
    ClassSpec { id: "frigate_general", name: "General Frigate", class: "frigate", hull: HullKind::FrigateGeneral, accent: [150, 160, 180], mass: 4000.0, max_speed: 6.0, accel: 5.0, turn_deg: 30.0, crew: 18, salvage: 300.0, build_time: 50.0, cargo: None, bays: None },
    ClassSpec { id: "frigate_missile", name: "Missile Frigate", class: "frigate", hull: HullKind::FrigateMissile, accent: [200, 80, 90], mass: 4200.0, max_speed: 5.5, accel: 4.5, turn_deg: 28.0, crew: 18, salvage: 340.0, build_time: 55.0, cargo: None, bays: None },
    ClassSpec { id: "capital_destroyer", name: "Destroyer", class: "capital", hull: HullKind::CapitalDestroyer, accent: [170, 120, 210], mass: 16000.0, max_speed: 4.0, accel: 3.0, turn_deg: 14.0, crew: 60, salvage: 900.0, build_time: 110.0, cargo: None, bays: None },
    ClassSpec { id: "carrier", name: "Carrier", class: "ark", hull: HullKind::Carrier, accent: [120, 180, 230], mass: 40000.0, max_speed: 3.0, accel: 2.0, turn_deg: 8.0, crew: 120, salvage: 5000.0, build_time: 300.0, cargo: None, bays: Some(2) },
];
